...
namespace InventorySystem {
    ...
    public partial class CustomerTable : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CustomersRow AddCustomersRow(string First_Name, string Surname, int Stocks, string Phone_Number, string Email, string Address) {
        ...
        public partial class CustomersRow : global::System.Data.DataRow {
            ...
            public int Stocks {
                get {
                    return ((int)(this[this.tableCustomers.StocksColumn]));
                }
                set {
                    this[this.tableCustomers.StocksColumn] = value;
                }
            }
...
namespace InventorySystem.CustomerTableTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Customers] WHERE (([First_Name] = @Original_First_Name) AND ([Surname] = @Original_Surname) AND ([Stocks] = @Original_Stocks) AND ([Phone_Number] = @Original_Phone_Number) AND ([Email] = @Original_Email) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Customers] ([First_Name], [Surname], [Stocks], [Phone_Number], [Email], [Address]) VALUES (@First_Name, @Surname, @Stocks, @Phone_Number, @Email, @Address);
SELECT First_Name, Surname, Stocks, Phone_Number, Email, Address FROM Customers WHERE (First_Name = @First_Name)";
...
SELECT First_Name, Surname, Stocks, Phone_Number, Email, Address FROM Customers WHERE (First_Name = @First_Name)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT First_Name, Surname, Stocks, Phone_Number, Email, Address FROM dbo.Custome" +
                "rs";
        ...
        public virtual int Fill(CustomerTable.CustomersDataTable dataTable) {
        ...
        public virtual CustomerTable.CustomersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CustomerTable.CustomersDataTable dataTable = new CustomerTable.CustomersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CustomerTable.CustomersDataTable dataTable) {
        ...
        public virtual int Delete(string Original_First_Name, string Original_Surname, int Original_Stocks, string Original_Phone_Number, string Original_Email, string Original_Address) {
        ...
        public virtual int Insert(string First_Name, string Surname, int Stocks, string Phone_Number, string Email, string Address) {
            if ((First_Name == null)) {
        ...
        public virtual int Update(string First_Name, string Surname, int Stocks, string Phone_Number, string Email, string Address, string Original_First_Name, string Original_Surname, int Original_Stocks, string Original_Phone_Number, string Original_Email, string Original_Address) {
            if ((First_Name == null)) {
                throw new global::System.ArgumentNullException("First_Name");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[8].Value = ((int)(Original_Stocks));
            if ((Original_Phone_Number == null)) {
                throw new global::System.ArgumentNullException("Original_Phone_Number");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Surname, int Stocks, string Phone_Number, string Email, string Address, string Original_First_Name, string Original_Surname, int Original_Stocks, string Original_Phone_Number, string Original_Email, string Original_Address) {
            return this.Update(Original_First_Name, Surname, Stocks, Phone_Number, Email, Address, Original_First_Name, Original_Surname, Original_Stocks, Original_Phone_Number, Original_Email, Original_Address);
        }
    }
