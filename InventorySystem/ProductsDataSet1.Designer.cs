...
namespace InventorySystem.ProductsDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([Id], [Product_Name], [Price_per_Product]) VALUES (" +
                "@Id, @Product_Name, @Price_per_Product);\r\nSELECT Id, Product_Name, Price_per_Pro" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [Id] = @Id, [Product_Name] = @Product_Name, [Price_per_Product] = @Price_per_Product WHERE (([Id] = @Original_Id) AND ([Product_Name] = @Original_Product_Name) AND ([Price_per_Product] = @Original_Price_per_Product));
