...
namespace InventorySystem {
    ...
    public partial class VendorsDataSet : global::System.Data.DataSet {
        ...
        public partial class VendorsDataTable : global::System.Data.TypedTableBase<VendorsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public VendorsRow AddVendorsRow(int Id, string Vendor_Name, string Email, decimal Phone, string Address) {
...
namespace InventorySystem.VendorsDataSetTableAdapters {
    ...
    public partial class VendorsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Vendors] WHERE (([Id] = @Original_Id) AND ([Vendor Name] = @Or" +
                ...
                "ne) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_A" +
                "ddress)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Vendors] ([Id], [Vendor Name], [Email], [Phone], [Address]) VA" +
                "LUES (@Id, @Vendor_Name, @Email, @Phone, @Address);\r\nSELECT Id, [Vendor Name], E" +
                "mail, Phone, Address FROM Vendors WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Vendors] SET [Id] = @Id, [Vendor Name] = @Vendor_Name, [Email] = @Email, [Phone] = @Phone, [Address] = @Address WHERE (([Id] = @Original_Id) AND ([Vendor Name] = @Original_Vendor_Name) AND ([Email] = @Original_Email) AND ([Phone] = @Original_Phone) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)));
SELECT Id, [Vendor Name], Email, Phone, Address FROM Vendors WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, [Vendor Name], Email, Phone, Address FROM dbo.Vendors";
        ...
        public virtual int Delete(int Original_Id, string Original_Vendor_Name, string Original_Email, decimal Original_Phone, string Original_Address) {
        ...
        public virtual int Insert(int Id, string Vendor_Name, string Email, decimal Phone, string Address) {
        ...
        public virtual int Update(int Id, string Vendor_Name, string Email, decimal Phone, string Address, int Original_Id, string Original_Vendor_Name, string Original_Email, decimal Original_Phone, string Original_Address) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Vendor_Name, string Email, decimal Phone, string Address, int Original_Id, string Original_Vendor_Name, string Original_Email, decimal Original_Phone, string Original_Address) {
            return this.Update(Original_Id, Vendor_Name, Email, Phone, Address, Original_Id, Original_Vendor_Name, Original_Email, Original_Phone, Original_Address);
        }
    }
